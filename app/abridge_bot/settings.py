...
MSG_PRIMARY_NAMES = [
    ...
    ('Отправил вопрос в поддержку'.lower().replace(' ', ''), 'Отправил вопрос в поддержку'),
]
PROGREV_NAMES = [
    ('progrev_1', 'Прогрев 1'),
    ...
    ('прогрев1', 'Прогрев 1'),
    ('Неверная ссылка-приглашение'.lower().replace(' ', ''), 'Неверная ссылка-приглашение'),
    ('Верня ссылка приграшение'.lower().replace(' ', ''), 'Верня ссылка приграшение'),
    ('Новый пользователь по ссылке'.lower().replace(' ', ''), 'Новый пользователь по ссылке'),
]
YOO_MSG_NAMES = [
    ...
    ('платежпрошелуспешно', 'Платеж прошел успешно'),
    ('платежотменен', 'Платеж отменен'),
    ('платежвозвращен', 'Платеж возвращен'),
    ('ошибкаплатежа', 'Ошибка платежа'),
    ('бонусныйкешбек', 'Бонусный кешбек'),
    ('бонусныйпроцент', 'Бонусный процент'),
]
VPN_MSG_NAMES = [
    ...
    ('У вас нету заказов'.lower().replace(' ', ''), 'У вас нету заказов'),
    ('У вас прежний тариф'.lower().replace(' ', ''), 'У вас прежний тариф'),
    ('Не хватает средств'.lower().replace(' ', ''), 'Не хватает средств'),
    ('Тариф изменен'.lower().replace(' ', ''), 'Тариф изменен'),
    ('Покупка ГБ успешна'.lower().replace(' ', ''), 'Покупка ГБ успешна'),
    ('Покупка ГБ успешна 1'.lower().replace(' ', ''), 'Покупка ГБ успешна'),
]
PROXY_NAMES = [
