    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('remember_answer', models.BooleanField(blank=True, default=False, help_text='Запомомнить на какую кнопку нажал пользователь. Результат будет доступен в след сообщениях через keywords', verbose_name='Запомнить ответ')),
