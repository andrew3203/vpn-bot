    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('need_routing', models.BooleanField(blank=True, default=True, help_text='Нужно ли искать сообщения, соответсвующие кнопкам. Используеться для создания интерактивных маршрутов.', verbose_name='Роутинг')),
                ('message_code', models.CharField(blank=True, default=None, help_text='Если роутинг выключен, то по данному коду в следующих сообщениях можно вывести результат пользовательского ответа.', max_length=80, null=True, verbose_name='Код сообщения')),
